---
name: speckit-verification-gate-run
description: 'Spec-kit workflow command: speckit-verification-gate-run'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: verification-gate:commands/speckit.verification-gate.run.md
---
