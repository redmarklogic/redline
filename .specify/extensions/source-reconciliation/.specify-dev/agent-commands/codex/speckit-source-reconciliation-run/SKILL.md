---
name: speckit-source-reconciliation-run
description: 'Spec-kit workflow command: speckit-source-reconciliation-run'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: source-reconciliation:commands/speckit.source-reconciliation.run.md
---
