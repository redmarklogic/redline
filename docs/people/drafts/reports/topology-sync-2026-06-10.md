...
| A-13 | **DECIDED 2026-06-11** — founder adopted launch-anchored kill clock ("Launch Day" = Skeleton Generator publicly reachable AND issue #73 signup flow live) with **2026-07-31 backstop** (briefly set to 06-29, reverted same day — Ron's annotation in the bet records it). Applied by Ron to strategic-bets.md + okrs/2026-h2.md KR1 re-anchoring |
