...
| `source_add` / `source_delete` / `source_list_drive` / `source_sync_drive` / `source_describe` / `source_rename` | Source management |
...
| `notebook_describe` | AI summary (can be long; use `notebook_query` with a specific question instead) |
