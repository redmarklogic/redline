...
**Hard rule:** No AI-assisted content with a domain claim ships without Graeme's
sign-off.
...
Not every AI-assisted piece needs Graeme. Triage by claim type:

| Claim type | Example | Review required |
|------------|---------|-----------------|
| **Domain-technical** | "BS 5930 clause 6.4 requires…" / "The bearing capacity formula is…" | **Graeme — mandatory, blocking** |
| **Product-factual** | "Redline supports DOCX export" / "Redline integrates with X" | **Mark — mandatory, blocking** |
| **Strategic-positional** | "Redline competes with X by…" / "The market for AI in civil engineering is…" | **Ron — mandatory, blocking** |
| **General-marketing** | "Engineers value clarity" / "Trust is built over time" | John self-review |
| **Pure-stylistic** | Headlines, transitions, meta descriptions | John self-review |
...
5. **Send for sign-off.** Route to Graeme/Mark/Ron per the triage table above.
...
- **Reviewer fatigue shortcuts.** "Looks fine, ship it" without claim-tracing.
  Make Graeme actually open the standard.
- **Publishing during reviewer absence.** If Graeme is on leave, technical posts
...
- Domain reviewer: Graeme — see `.github/agents/rl.graeme.agent.md` and
  `docs/knowledge/geotechnical/`.
- Product reviewer: Mark.
- Strategy reviewer: Ron.
