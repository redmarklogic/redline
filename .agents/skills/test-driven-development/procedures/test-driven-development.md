# Test Driven Development — Detailed Reference
...
<Bad>
```python
def test_retry_works(mocker) -> None:
...
For Python-specific test conventions (pytest, AAA pattern, fixtures, parametrize), use the `python-testing-unit` skill.
