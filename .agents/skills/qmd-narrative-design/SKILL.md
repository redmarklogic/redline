...
description: Story-driven narrative design for Quarto reports and presentations. Covers the Hook-Problem-Insight-Proof-Action arc, audience-aware content density, slide composition, speaker notes, writing quality rules, and the clarifying questions to ask before generating content. Applies to both revealjs presentations and HTML/PDF reports.
---
