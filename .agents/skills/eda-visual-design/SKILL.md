...
description: Design principles for statistical and EDA visualisations. Language-agnostic rules for choosing chart types, encoding data, reducing cognitive load, and annotating plots. Grounded in Tufte, Cleveland, and Norman.
---
