...
| Branch / PR workflow | `dispatching-parallel-agents`, `subagent-driven-development`, `using-git-worktrees`, `requesting-code-review`, `resolving-pr-issues`, `/make-pr` command |
